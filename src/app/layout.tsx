...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "phone holder",
    "phone stand holder",
    "phone stand holder for her",
    "phone stand holder for him",
    "phone stand holder for kids",
    "phone stand holder for family",
    "custom desk decor",
    "custom desk decor gifts",
    "custom desk decor gifts for her",
    "custom desk decor gifts for him",
    "custom desk decor gifts for kids",
    "custom desk decor gifts for family",
    "custom desk decor gifts for friends",
    "earrings",
    "desk accessories",
    "desk decor",
    "desk decor gifts",
